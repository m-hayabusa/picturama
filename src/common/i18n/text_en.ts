export default {
    ...
    PhotoDetailBody_error_loadingFailed: 'Loading photo failed',
    PhotoDetailBody_error_loadingFailed_desc: `Picturama can't load this photo`,
    ...
    SelectionSummary_clearSelection: 'Clear selection',
